...
def _loadUiType(uiFile):
    """
    Runtime .ui compilation is disabled in this QGIS plugin bundle.
    """
    raise RuntimeError("Runtime .ui compilation is not included in this plugin bundle.")
...
# Keep the historical Qt event-loop alias for pyqtgraph callers.
def exec_():
    app = mkQApp()
