...
def main() -> int:
    ...
    checks = [
        ...
        ("KP range highlighter from CSV", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_kp_range_csv")),
        ...
        ("cable lay project data file ops", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_cable_lay_gpkg_ops")),
        ...
        ("RPL revision comparison (pure)", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_rpl_compare")),
        ...
        ("burial planner ground model + KP re-reference (pure)", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_ground")),
        ("burial planner tools registry (pure)", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_tools")),
        ("burial planner installation paths (pure)", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_paths")),
        ("burial planner installation path task", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_path_task")),
        ("burial planner store", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_store")),
        ("burial planner ground model store + widgets", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_ground_store")),
        ("burial planner BAS register (pure)", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_bas")),
        ("burial planner BAS store + spreadsheet tab", lambda: _run_module(f"{PACKAGE_NAME}.tests.test_burial_bas_store")),
